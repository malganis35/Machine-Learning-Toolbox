...
How to install the GIT Repo in your computer
...
* Demander les accès/permissions du dossier Github à Cao Tri DO (malganis35).
(NB : créer au préalable un compte sur Github : https://github.com/)
* Cloner le repository :
-- clique droit sur un répertoire, sélectionner "Git Clone"
-- adresse : https://github.com/malganis35/machineLearningToolbox.git
...
To add the Agile Board to your GitHub, go to Zenhust